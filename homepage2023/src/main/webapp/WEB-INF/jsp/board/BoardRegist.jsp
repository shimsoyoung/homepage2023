			...
			<table class="chart2">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<label for="noticAtY">예 : </label>
							<input type="radio" id="noticAtY" value="Y" name="noticAt" <c:if test="${result.noticeAt eq 'Y'}">checked="checked"</c:if>/>
							&nbsp;&nbsp;&nbsp;
							<label for="notictAtN">아니오 : </label>
							<input type="radio" id="noticAtN" value="N" name="noticAt" <c:if test="${result.noticeAt ne 'N'}">checked="checked"</c:if>/>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<input type="radio" id="othbcAtN" value="N" name="othbcAt" <c:if test="${result.othbcAt ne 'N'}">checked="checked"</c:if>/>
						</td>
					</tr>
					<tr>
			...
			<div class="btn-cont ar">
				<c:choose>
					<c:when test="${not empty searchVO.boardId}">
						...
						<a href="${delUrl}" id="btn-reg" class="btn">삭제</a>
					</c:when>
					<c:otherwise>
